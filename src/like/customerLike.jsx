...
const CustomerLike = () => {
  return (
    <section className="flex flex-col w-[100%] justify-center items-center mt-[2rem]">




    {/* New ArrivalSection */}
    <div  className="flex flex-col items-start justify-start bg-[#FAFEFF] w-[100%]  rounded-[24px] p-[24px]">
            {/* heading */}
            <div>
            <h1  className="text-[#B607A4] font-[500] text-[48px] leading-[80px]">Customers also Like</h1>
        </div>

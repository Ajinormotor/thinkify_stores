...
const CustomerLike = () => {
  ...
  return (
    <section className="flex flex-col  bg-[#FAFEFF] w-[100%] 
     rounded-[24px] p-[24px]  justify-center items-center mt-[2rem]">
    {/* New Arrival Section */}
    <div className="flex flex-col items-start justify-start ">
      {/* Heading */}
      <div>
        <h1 className="text-[#B607A4] font-[500] text-[36px] leading-[40px]">Continue Shopping</h1>
      </div>
      
      {/* Mapping with image slider */}
      <div className="grid grid-col-1 md:grid-cols-2 w-[100%] justify-between rounded-[24px] gap-[18px] lg:gap-[57px]   pt-[2rem]

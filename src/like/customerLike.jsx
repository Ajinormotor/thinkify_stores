...
import {  shoppingdata} from "../assets/data/arrivaldata";
...
const CustomerLike = () => {
  ...
  return (
   ...
   <div className="flex flex-col items-start justify-start w-[368px] md:w-[100%]">
     {/* Heading */}
     <div>
       <h1 className="text-[#B607A4] font-[500] md:text-[48px] text-[16px]  p-2
       leading-[15px] md:leading-[80px]">Continue Shopping</h1>
     </div>
     
     {/* Mapping with image slider */}
     <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4  rounded-[24px] md:gap-[18px]  
    pt-[2rem] space-x-3  ">
         ...
         md:rounded-[24px] rounded-[12px] gap-[12px]  my-[1rem] md:gap-[10px] p-[15px] bg-[#F8F8F8]">
           ...
           <ul className="flex md:gap-[55px] gap-[36px] h-[54px] items-center md:justify-between justify-center w-[100%]">
             ...
             <li>
               ...
               hover:text-[#08AC9F] hover:bg-[#fff] hover:border-[#08AC9F]  md:w-[113px] md:h-[43px]

...
const DiscountSales = () => {
  ...
  return (
   ...
   <div className="flex flex-col items-start justify-start w-[368px] md:w-[100%]">
     {/* Heading */}
     <div>
       <h1 className="text-[#B607A4] p-2 font-[500] md:text-[48px] text-[16px] leading-[15px] md:leading-[80px]">Discount Sales</h1>
     </div>
       ...
       {bulkdata.map((item) => (
         ...
         md:rounded-[24px] rounded-[12px] gap-[12px]  my-[1rem] md:gap-[10px] p-[15px] bg-[#F8F8F8]">
           ...
           <ul className="flex md:gap-[55px] gap-[36px] h-[54px] items-center md:justify-between justify-center w-[100%]">
             ...
             <li>
               <button onClick={() => handleAddToCart(item)} className="md:px-[0.5rem]  hover:text-[#08AC9F] 
               hover:bg-[#fff] hover:border-[#08AC9F] md:w-[113px] md:h-[43px]

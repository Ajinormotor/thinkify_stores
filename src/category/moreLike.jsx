...
const MoreLike = () => {
  return (
    <section className="flex flex-col w-[100%] justify-center items-center md:ml-[2rem] lg:ml-[1rem]   mt-[2rem]">
    ...
    <div  className="flex flex-col items-start justify-start bg-[#FAFEFF] w-[100%] lg:ml-[10rem] rounded-[24px] p-[24px]">
            {/* heading */}
            <div>
            <h1  className="text-[#B607A4] font-[500] text-[48px] leading-[80px]">More Like This</h1>
        </div>
    
        {/* mappping with img slider */}
    
        <div className="flex flex-col md:flex-row w-[100%] rounded-[24px] gap-0 md:justify-between ">

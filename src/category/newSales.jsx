...
import { allsalesdata, } from "../assets/data/arrivaldata";
...
const AllSales = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-start justify-start w-[368px] md:w-[100%]">
      {/* Heading */}
      <div>
        <h1 className="text-[#B607A4] font-[500] p-2 md:text-[48px] text-[16px] leading-[15px] md:leading-[80px]">All Sales</h1>
      </div>
        ...
        {allsalesdata.map((item) => (
          ...
          md:rounded-[24px] rounded-[12px] gap-[12px]  my-[1rem] md:gap-[10px] p-[15px] bg-[#F8F8F8]">
            ...
            <ul className="flex md:gap-[55px] gap-[36px] h-[54px] items-center md:justify-between justify-center w-[100%]">
              ...
              <li>
                <button onClick={() => handleAddToCart(item)} className="md:px-[0.5rem]  hover:text-[#08AC9F] hover:bg-[#fff]
                 hover:border-[#08AC9F] lg:w-[[113px] md:h-[40px] md:rounded-[30PX]
                flex w-[76px] h-[27px] border-[1.8px] text-wrap  border-[#F5F5F5] bg-[#08AC9F] text-[12px] leading-[25px]
                 text-[#F8F8F8] rounded-[20px] items-center justify-center">
                  Add Cart
                </button>
              </li>

import { arrivaldata } from "../assets/data/arrivaldata"
...
const NewSales = () => {
  return (
    <section className="flex flex-col w-[100%] justify-center items-center md:ml-[2rem] lg:ml-[5rem] ">
    ...
    <div  className="flex flex-col items-start justify-start bg-[#FAFEFF] w-[100%] lg:ml-[10rem] rounded-[24px] p-[24px]">
            {/* heading */}
            <div>
            <h1  className="text-[#B607A4] font-[500] text-[48px] leading-[80px]">New Sales</h1>
        </div>
